<template>
  ...
  <body v-if="this.showRules === false" class="game-body">
    ...
    <GameComponent
        v-if="this.game_state==='game_running' && this.backendOnline===true"
    ...
    <div v-if="this.backendOnline===false" class="row">
          <div class="col-3"></div>
          <div class="col-6 cen">
            <h1 class="playernamecenter"> Server currently offline, please reload the page </h1>
          </div>
          <div class="col-3"></div>
        </div>
